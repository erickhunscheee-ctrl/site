...
export function StreamingSection() {
  ...
  const totalPages = data ? Math.ceil((data.shows?.length || 0) / itemsPerPage) : 1
          ...
          >
            <div className="flex gap-4">
              <div className="flex-shrink-0">
                <img
                  src={show.imageSet?.verticalPoster?.w240 || "/placeholder.svg?height=120&width=80&query=movie+poster"}
                  alt={show.title}
